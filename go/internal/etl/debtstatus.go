...
var companyNames = map[string]string{
	// 15 ЮЛ ГК из ТЗ (seed.go::entities). РБ/РФ:
	...
	// КЗ / УЗ:
	"141240004842": "ТОО «Mark Formelle Kazakhstan»",
	"305554644":    "ООО «MARK FORMELLE IT» МЧЖ",
	"310170662":    "«BARREIROS SOFT» MCHJ",
	// Зарубежные (план счетов не подтверждён — данных может не быть):
	"6201029158":         "MF FASHION TEKSTIL (Турция)",
	"CZ08373159":         "Mark Formelle EU s.r.o (Чехия)",
	"40003074497":        "Hutchison Trading LP (Великобритания)",
	"91310115MAK0BGF88G": "MARK FORMELLE TRADE SHANGHAI (Китай)",
	"315362-3301-000":    "ООО «МАРК ФОРМЭЛЬ КЕЙДЖИ» (Кыргызстан)",
}
