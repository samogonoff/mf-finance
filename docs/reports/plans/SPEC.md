...
| Блокирует | Вопрос |
|---|---|
| включение inverse на боевой период | §12 п.11 — подтверждение инверсии; п.5 — кто утверждает условия |
| МП-08/МП-11 | §12 п.6 (владелец 51/52), п.10 (конфликт кодов 52/54) |
| источник ставки НДС | §12 п.4 — откуда берётся эффективная ставка на плановый период |
| курс тактики | §12 п.12 — какой объект Budgeting держит курс сценария «Тактика» |
| публикация (запись) | §12 п.1/2/13 — «Параметр», агрегат vs детализация, BYN-пара, уникальный индекс |
| ABAC розницы | Розница §12 п.3 — доменный логин в `DimEmployee` для связки с RegManager |
| параметры ФОТ/аренды | Розница §12 п.12/13 — база порога 106 %, пороги оборота |
