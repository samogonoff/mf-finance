...
_CACHE_NON_TEXT: set[str] = {
    ...
    "Пошив факт, минуты", "Пошив факт, руб.", "Пошив факт, USD.",
    "Раскрой факт, минуты", "Раскрой факт, руб.", "Раскрой факт, USD.",
    "Себестоимость факт, руб.", "Себестоимость факт, USD.",
    "Норма",
...
CACHE_COLUMNS: list[str] = [
    ...
    "Вязание, руб.", "Вязание, USD.",
    "Себестоимость, руб.", "Себестоимость, USD.",
    # Факт по стоимости минуты (миграция 0042). С 01.01.2026 Лиса ведёт
    # ФАКТИЧЕСКУЮ стоимость минуты пошива и раскроя помесячно (константы
    # *_MIN_F), источник считает по ней вторую себестоимость. До 2026 года
    # колонки пусты — факта не было, это не пропуск. Дашборды маржи выпуска
    # ведутся по факту с подписью, норматив — для отклонений (заказчик,
    # 27.08.2026). Наполняются только ПОЛНЫМ обновлением кэша: частичное берёт
...
async def sync_plan_prices() -> int:
    ...
    «Отклонения по артикулам» дашборда маржи (миграция 0050).
